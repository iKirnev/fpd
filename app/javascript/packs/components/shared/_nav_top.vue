      ...
      <b-navbar class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <b-collapse is-nav id="nav_collapse">
          <b-navbar-nav>
            ...
            <b-nav-item :to="{ name: 'galleries_path' }">{{ $t('nav.galleries') }}</b-nav-item>
            <b-nav-item :to="{ name: 'furniture_path' }">{{ $t('nav.furniture') }}</b-nav-item>
            <b-nav-item :to="{ name: 'price_path' }">{{ $t('nav.price') }}</b-nav-item>
            <b-nav-item :to="{ name: 'contacts_path' }">{{ $t('nav.contacts') }}</b-nav-item>
