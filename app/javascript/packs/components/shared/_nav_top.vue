      ...
      <b-navbar class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <b-collapse is-nav id="nav_collapse">
          <b-navbar-nav>
            ...
            <b-nav-item @click="select" :to="{ name: 'products_path' }" :class="activeOn(['products_path', 'doors_path','doors_result_path'])">{{ $t('nav.products') }}</b-nav-item>
            <b-nav-item @click="select" :to="{ name: 'galleries_path' }" :class="activeOn(['galleries_path'])">{{ $t('nav.galleries') }}</b-nav-item>
            <b-nav-item @click="select" :to="{ name: 'furniture_path' }" :class="activeOn(['furniture_path'])">{{ $t('nav.furniture') }}</b-nav-item>
